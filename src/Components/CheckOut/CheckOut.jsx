    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <div className="text-center">
          ...
          <button
            onClick={() => navigate('/')}
            className="px-6 py-3 bg-[#f44336] text-white font-bold rounded-md hover:bg-purple-700 transition duration-300"
          >
            Go to Shop
          </button>
        </div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-4">
                ...
                <input
                  ...
                  className="mt-1 block w-full h-12 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50 text-black"
                  required
                />
                {errors.email && <p className="text-red-500 text-sm" style={{ color: 'white' }}>{errors.email}</p>}
              </div>
              <div className="mb-4">
                ...
                <textarea
                  ...
                  required
                />
                {errors.address && <p className="text-red-500 text-sm" style={{ color: 'white' }}>{errors.address}</p>}
              </div>
              <div className="mb-4">
                <label htmlFor="contact" className="block text-sm font-medium" style={{ color: '#fff' }}>
                  Enter Your Contact
                </label>
                <input
                  type="text"
                  ...
                  value={form.contact}
                  onChange={handleChange}
                  className="mt-1 block h-12 w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50 text-black"
                  required
                />
                {errors.contact && <p className="text-red-500 text-sm" style={{ color: 'white' }}>{errors.contact}</p>}
              </div>
              <div className="mb-4">
                ...
                <div className="flex items-center mt-1">
                  <label htmlFor="paymentMethodCash" className="flex items-center mr-4">
                    <input
                      type="radio"
                      ...
                      onChange={handleChange}
                      className="form-radio h-5 w-5 text-[#f44336]"
                    />
                    <span className="ml-2 text-white">Cash</span>
                  </label>
                  <label htmlFor="paymentMethodCheque" className="flex items-center">
                    <input
                      type="radio"
                      ...
                      className="form-radio h-5 w-5 text-[#f44336]"
                    />
                    <span className="ml-2 text-white">Cheque</span>
                  </label>
                </div>
              </div>
              <button
                type="submit"
                className="w-full px-6 py-3 bg-[#f44336] text-white font-bold rounded-md hover:bg-white hover:text-[#f44336] border-2 border-[#f44336] transition duration-300"
              >
                Submit
              </button>
            </form>
