                ...
                <div className="flex items-center justify-between p-4 border-b border-gray-200">
                  ...
                  <div className="text-right flex flex-col justify-between">
                    ...
                    <button
                      ...
                      className="mt-2 text-[#f44336] hover:text-red-700 hover:bg-white  transition duration-300"
                    >
                      Remove
                    </button>
                  </div>
          ...
          <div className="mt-8 flex justify-end">
            <div className="bg-white shadow-md rounded-lg p-4 w-full md:w-96">
              ...
              <button
                ...
                className="w-full bg-[#f44336] text-white font-bold py-2 rounded-md hover:text-[#f44336] border-2 border-[#f44336] hover:bg-white transition duration-300"
              >
                Proceed to Checkout
              </button>
            </div>
